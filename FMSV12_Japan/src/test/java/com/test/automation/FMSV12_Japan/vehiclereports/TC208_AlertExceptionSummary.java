 ...
 *
 */
public class TC208_AlertExceptionSummary extends  TestBase {
	...
	public void verifyAlertExceptionSummaryOption(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started--->Alert Expection Summary Report Module");
		...
		log("=========>Finished--->Alert Expection Summary Report Module");
	}
