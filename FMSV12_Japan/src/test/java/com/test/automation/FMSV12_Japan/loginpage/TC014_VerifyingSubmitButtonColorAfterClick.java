 ...
 *
 */
public class TC014_VerifyingSubmitButtonColorAfterClick extends TestBase {

	public static final Logger log = Logger.getLogger(TC014_VerifyingSubmitButtonColorAfterClick.class.getName());
