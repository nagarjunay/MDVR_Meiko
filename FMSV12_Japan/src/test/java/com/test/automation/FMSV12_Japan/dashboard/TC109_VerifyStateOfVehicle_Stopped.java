 ...
 *
 */
public class TC109_VerifyStateOfVehicle_Stopped extends TestBase{
	...
	public void Verify_StoppedState(String loginid, String password, String runMode) throws Exception {
		...
		log("=========>Started Stopped Vehicles Report");
		loginpage = new LoginPage(driver);
		loginpage.loginToApplication(loginid, password);
		moving = new DashBoard_StateOfVehicle(driver);
		moving.Verifying_StateOfStoppedVehicles();;
		// moving.Verifying_Copybutton();
		log("=========>Finished Stopped Vehicles Report");
