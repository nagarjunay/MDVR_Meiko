 ...
 *
 */
public class TC201_06_VerifyActivityReport_UnauthorizedStopReport extends TestBase{
	...
	public void verifyActivityOption_unauthorizedStopReport(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started--->Verifying Activity Report->Unauthorized Stop Report");
