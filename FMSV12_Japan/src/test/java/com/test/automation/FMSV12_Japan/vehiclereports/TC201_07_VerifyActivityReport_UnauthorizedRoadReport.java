 ...
 *
 */
public class TC201_07_VerifyActivityReport_UnauthorizedRoadReport extends TestBase{
	...
	public void verifyActivityOption_unauthorizedRoadReport(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started--->Verifying Activity Report->Unauthorized Road Report");
		...
		log("=========>Finished--->Verifying Activity Report->Unauthorized Road Report");
	}
