...
public class TC007_VerifyingStateOfVehicle extends TestBase {

	public static final Logger log = Logger.getLogger(TC007_VerifyingStateOfVehicle.class.getName());
	LoginPage loginpage;
