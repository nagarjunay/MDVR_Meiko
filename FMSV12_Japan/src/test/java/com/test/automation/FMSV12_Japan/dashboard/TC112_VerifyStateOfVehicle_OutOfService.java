 ...
 *
 */
public class TC112_VerifyStateOfVehicle_OutOfService extends TestBase {
	...
	public void a_outofserviceState(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started Out Of Service Vehicles Report");
		loginpage = new LoginPage(driver);
		loginpage.loginToApplication(loginid, password);
		moving = new DashBoard_StateOfVehicle(driver);
		moving.Verifying_StateOfOutOfServiceVehicles();
		// moving.Verifying_Copybutton();
		log("=========>Finished Out Of Service Vehicles Report");
	...
	@Test()
	public void b_OutOfServiceVehiclesReport_VerifyRecordsperpageDropdown() throws Exception {
