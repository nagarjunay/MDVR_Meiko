 ...
 *
 */
public class TC201_05_VerifyActivityReport_HarshAccelerationReport extends TestBase{
	...
	public void verifyActivityOption_harshAccelerationReport(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started--->Verifying Activity Report->Harsh Acceleration Report");
