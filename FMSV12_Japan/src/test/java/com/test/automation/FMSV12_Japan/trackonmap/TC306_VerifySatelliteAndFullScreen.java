 ...
 *
 */
public class TC306_VerifySatelliteAndFullScreen extends TestBase{
	...
	public void verifySatelliteMode(String loginid, String password, String runMode) throws Exception {
