 ...
 *
 */
public class TC111_VerifyStateOfVehicle_Inactive extends TestBase{
	...
	public void inactiveState(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started Inactive Vehicles Report");
		loginpage = new LoginPage(driver);
		loginpage.loginToApplication(loginid, password);
		moving = new DashBoard_StateOfVehicle(driver);
		moving.Verifying_StateOfInactiveVehicles();
		// moving.Verifying_Copybutton();
		log("=========>Finished Inactive Vehicles Report");
	...
	@Test(priority = 2)
	public void InactiveVehiclesReport_VerifyRecordsperpageDropdown() throws Exception {
