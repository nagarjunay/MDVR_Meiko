 ...
 *
 */
public class TC011_VerifyLoginPageMeikoLogo extends TestBase{
	
	public static final Logger log = Logger.getLogger(TC011_VerifyLoginPageMeikoLogo.class.getName());
