 ...
 *
 */
public class TC110_VerifyStateOfVehicle_Idle extends TestBase{
	...
	public void a_idleState(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started Idle Vehicles Report");
		loginpage = new LoginPage(driver);
		loginpage.loginToApplication(loginid, password);
		moving = new DashBoard_StateOfVehicle(driver);
		moving.Verifying_StateOfIdleVehicles();
		// moving.Verifying_Copybutton();
		log("=========>Finished Idle Vehicles Report");
	...
	@Test()
	public void b_IdleVehiclesReport_VerifyRecordsperpageDropdown() throws Exception {
