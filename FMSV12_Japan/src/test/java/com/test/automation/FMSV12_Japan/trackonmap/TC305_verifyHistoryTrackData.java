 ...
 *
 */
public class TC305_verifyHistoryTrackData extends TestBase {
	...
	public void verifyHistoryTrackData(String loginid, String password, String runMode) throws Exception {
		if (runMode.equalsIgnoreCase("n")) {
			throw new SkipException("User marked this not to run");
		}
		log("=========>Started--->Verify History Track Data");
		loginpage = new LoginPage(driver);
		loginpage.loginToApplication(loginid, password);
		tnm = new TrackOnMap(driver);
		tnm.verifyHistoryTrackData();
		log("=========>Finished--->Verify History Track Data");
	}
