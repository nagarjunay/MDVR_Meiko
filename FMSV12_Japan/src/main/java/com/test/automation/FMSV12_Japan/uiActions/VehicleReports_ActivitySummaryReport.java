...
public class VehicleReports_ActivitySummaryReport extends TestBase {
	...
	public static final Logger log = Logger.getLogger(VehicleReports_ActivitySummaryReport.class.getName());
	...
	public void ActivitySummary() throws InterruptedException {
		...
		test.log(LogStatus.INFO, "Clicked on activity summary option====>>" + activitysummary);
